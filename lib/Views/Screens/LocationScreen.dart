...
class _LocationScreenState extends State<LocationScreen> {
  ...
  void gettingServers() async {
    ...
    try {
      ...
      if (widget.countries.isEmpty) {
        ...
        if (locationController.countrylist.isEmpty ||
            locationController.flaglist.isEmpty) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: isBannerloaded == true
          ? SizedBox(height: 80, child: AdWidget(ad: bannerAd))
          : Container(),
  ...
  _loadingWidget(context) => SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Loading Servers ....',
              style: boldStyle.copyWith(fontSize: 17, color: white),
  ...
  _noVPNFound(context) => alertBox(
        txt: ' Sorry ,VPNs Not Found! 😔',
      );
            ...
            tap: (istap) async {
              setState(() {
                if (expandedCountry == country) {
                  ...
                  istap = true;
                  List<Vpn> specificCountryServers =
                      serversForSelectedCountry(country, context);
