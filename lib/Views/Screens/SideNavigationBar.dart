...
class _SideNavigationBarState extends State<SideNavigationBar> {
  ...
  Widget build(BuildContext context) {
        ...
        children: <Widget>[
            ...
            child: Container(
              ...
              child:Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10,),
                    Text('Safelink vpn'.toUpperCase() ,style: logoText.copyWith(fontSize:20,color:white),).animate().fade().slideX(curve: Curves.easeIn)
          ...
          DrawerItem(
            ...
            onTap: () async {
              ...
              final String appLink = 'com.example.Vpn';
    ...
    final RateUS= RatingDialog(starColor: IconBluecolor,
      ...
      ///  For Rating
      StoreRedirect.redirect(androidAppId: 'com.example.Vpn',iOSAppId: 'com.example.Vpn');
