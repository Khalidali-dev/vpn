...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text('Safelink vpn'.toUpperCase(),
              style: logoText.copyWith(fontSize: 22, color: white)),
          elevation: 0,
          leading: Builder(
              builder: (context) => // Ensure Scaffold is in context
                  IconButton(
                      icon: Icon(Icons.menu, color: white, size: 26),
          ...
          actions: [
            IconButton(
              ...
              icon: Icon(CupertinoIcons.globe, color: white, size: 28),
            )
          ],
        ),
        body: Column(
          ...
          children: [
            ...
            Expanded(flex: 1, child: ConnectionStatusLabel(context)),
            SizedBox(
              height: 8,
            ),
